...
const ProgressScreen = () => {
  ...
  const data = {
    daily: {
      ...
      datasets: [{ data: [20, 50, 30, 70] }],
    },
    weekly: {
      labels: ["Mon", "Tue", "Wed", "Thu", "Fri", "Sat", "Sun"],
      datasets: [{ data: [60, 70, 80, 90, 100, 110, 120] }],
    },
    monthly: {
      labels: ["Week 1", "Week 2", "Week 3", "Week 4"],
      datasets: [{ data: [250, 300, 350, 400] }],
    },
    yearly: {
      labels: ["Jan", "Feb", "Mar", "Apr", "May", "Jun", "Jul", "Aug", "Sep", "Oct", "Nov", "Dec"],
      datasets: [{ data: [1200, 1300, 1400, 1500, 1600, 1700, 1800, 1900, 2000, 2100, 2200, 2300] }],
    },
  };
  ...
  return (
    <LinearGradient colors={["#99b09d", "#132b17"]} style={styles.gradient}>
      <View style={styles.container}>
        <Text style={[styles.title, { marginTop: 40 }]}>Progress</Text>
